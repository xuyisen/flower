...
def factor_combine(factor: int, parameters: list[NDArray[Any, Any]]) -> list[NDArray[Any, Any]]:
    """Combine factor with parameters."""
    return [np.array([factor])] + parameters


def factor_extract(
    parameters: list[NDArray[Any, Any]],
) -> tuple[int, list[NDArray[Any, Any]]]:
    """Extract factor from parameters."""
    return int(parameters[0][0]), parameters[1:]


def get_parameters_shape(parameters: list[NDArray[Any, Any]]) -> list[tuple[int, ...]]:
...
def parameters_addition(
    parameters1: list[NDArray[Any, Any]], parameters2: list[NDArray[Any, Any]]
) -> list[NDArray[Any, Any]]:
    """Add two parameters."""
...
def parameters_mod(parameters: list[NDArray[Any, Any]], divisor: int) -> list[NDArray[Any, Any]]:
...
def parameters_multiply(
    parameters: list[NDArray[Any, Any]], multiplier: Union[int, float]
) -> list[NDArray[Any, Any]]:
...
def parameters_divide(
    parameters: list[NDArray[Any, Any]], divisor: Union[int, float]
) -> list[NDArray[Any, Any]]:
